...
export default function Sidebar() {
  ...
  return (
    <aside className="w-14 flex flex-col items-center py-4 gap-1 bg-bg-subtle border-r border-border shrink-0">
      {/* Logo */}
      <div className="w-8 h-8 rounded-lg bg-sand-400 flex items-center justify-center mb-4">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
          <path d="M8 2C8 2 3 5 3 9C3 11.2 5.2 13 8 13C10.8 13 13 11.2 13 9C13 5 8 2 8 2Z" stroke="#3D3228" strokeWidth="1.5" strokeLinejoin="round" fill="none"/>
          <circle cx="8" cy="9" r="1.5" fill="#3D3228"/>
        </svg>
      </div>
          ...
          <Link
            ...
            className={cn(
              ...
              active
                ...
                : 'text-text-subtle hover:text-text hover:bg-sand-200',
            )}
          >
