...
const SKILLS: SkillOption[] = [
  ...
  { command: 'research',       name: 'Deep Research',      description: 'Multi-source research + citations',          category: 'Research' },
  { command: 'compare',        name: 'Compare & Contrast', description: 'Scored comparison table + recommendation',   category: 'Research' },
  ...
  { command: 'news-digest',    name: 'News Digest',        description: 'Aggregate + summarize news from feeds',      category: 'Research' },
  { command: 'swot',           name: 'SWOT Analysis',      description: 'Evidence-backed SWOT analysis',              category: 'Strategy' },
  { command: 'okrs',           name: 'OKR Generator',      description: 'Well-formed OKRs from a strategic goal',     category: 'Strategy' },
  { command: 'competitor',     name: 'Competitor Profile', description: 'Full competitor intel from public sources',  category: 'Strategy' },
...
export default function ChatToolbar({ workflowId }: Props) {
  ...
  function selectSkill(skill: SkillOption) {
    // Remove any trailing "/" from input
