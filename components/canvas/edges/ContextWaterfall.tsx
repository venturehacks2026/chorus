    ...
    <EdgeLabelRenderer>
      ...
      >
        <button
          ...
          className="flex items-center gap-1.5 px-2.5 py-1.5 bg-input border border-input-border rounded-lg shadow-sm hover:shadow-md transition-all text-xs"
        >
          <ArrowRight className="w-3 h-3 text-sand-600" />
        ...
        {expanded && (
          <div className="mt-1 w-72 bg-input border border-input-border rounded-lg shadow-lg p-3 space-y-3">
            {inputPreview && (
              <div>
                <span className="text-[9px] font-bold uppercase tracking-wider text-sand-600">Input</span>
